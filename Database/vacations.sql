...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2023 at 04:06 PM
...
INSERT INTO `followers` (`usersId`, `vacationsId`) VALUES
(1, 4),
(3, 9),
(2, 4),
(3, 8),
...
(5, 'Hans', 'Niemann', 'hansniemann@gmail.com', 'HN123456', 'user'),
(10, 'Hans', 'Niemann', 'hansniemann@gmail.com', 'HN123456', 'user'),
(11, 'Fabiano', 'Caruana', 'fabianocaruana@gmail.com', 'Fc123456', 'user');
...
(2, 'Rome', 'Immerse yourself in the rich history of Rome, the \"Eternal City.\" Marvel at the Colosseum and ancient ruins, toss a coin in the Trevi Fountain, and savor the delicious Italian cuisine.', '2023-05-19', '2023-05-30', '1879.00', 'b8acfe6b-b7cc-41fc-a6d0-8fb5620a3168.jpg'),
...
(6, 'London', 'Discover the historic landmarks and modern culture of London. Visit the Tower of London, take a ride on the London Eye, and enjoy a traditional afternoon tea.', '2023-05-28', '2023-06-04', '2200.00', '2397a82a-78c0-4c81-85d0-12b9f49b2352 .jpg'),
...
(11, 'Tbilisi', 'Discover the unique culture and history of Tbilisi, the capital of Georgia. Visit the Narikala Fortress, taste the traditional Georgian cuisine, and relax in the sulfur baths.', '2023-05-24', '2023-06-04', '2789.00', '7870c267-b882-4df1-be4e-f2024c0881b7.jpg'),
...
--
ALTER TABLE `vacations`
  MODIFY `vacationsId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
